...
class AiringToday extends StatefulWidget {
  AiringToday({Key? key}) : super(key: key);
...
class _AiringTodayState extends State<AiringToday> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<TvShowsProvider>(context).getAiringToday().then((_) {
        setState(() {
          _isLoading = false;
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    _pageController.addListener(() {
      if (_pageController.offset >= _pageController.position.maxScrollExtent &&
        ...
        // reached bottom
        if (newPage < 3) {
          temp.addMoreAiringToday(nextPage: newPage);
          newPage += 1;
        } else {
          temp.setNoMore = true;
        }
        ...
        : Container(
            ...
            builder: (ctx, tvProvider, _) {
              return PageView.builder(
                  ...
                  itemCount: tvProvider.airingTodayLS.length,
                  ...
                  child: InkWell(
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) => TvShowDetailsScreen(
                              tvId: tvProvider.airingTodayLS[index].id))),
                                ...
                                child: ClipRRect(
                                    ...
                                    child: BlurHash(
                                      ...
                                      image: 'https://image.tmdb.org/t/p/w500' +
                                          tvProvider
                                              .airingTodayLS[index].posterPath,
                                    )))),
                        Padding(
                          padding:
                              const EdgeInsets.only(top: kDefaultPadding / 2),
                          child: Text(tvProvider.airingTodayLS[index].name,
                        ...
                        Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      tvProvider
                                          .airingTodayLS[index].voteAverage
                                          .toString(),
                                      style:
