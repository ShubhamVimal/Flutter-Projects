...
class OnTheAir extends StatefulWidget {
  OnTheAir({Key? key}) : super(key: key);
...
class _OnTheAirState extends State<OnTheAir> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<TvShowsProvider>(context).getOnTheAir().then((_) {
        setState(() {
          _isLoading = false;
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    _pageController.addListener(() {
      if (_pageController.offset >= _pageController.position.maxScrollExtent &&
        ...
        // reached bottom
        if (newPage < 3) {
          temp.addMoreOnTheAir(nextPage: newPage);
          newPage += 1;
        } else {
          temp.setNoMore = true;
        }
        ...
        : Container(
            ...
            builder: (ctx, tvProvider, _) {
              return PageView.builder(
                  ...
                  itemCount: tvProvider.onTheAirLS.length,
                  ...
                  child: InkWell(
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) => TvShowDetailsScreen(
                              tvId: tvProvider.onTheAirLS[index].id))),
                                ...
                                child: ClipRRect(
                                    ...
                                    child: BlurHash(
                                      ...
                                      image: 'https://image.tmdb.org/t/p/w500' +
                                          tvProvider
                                              .onTheAirLS[index].posterPath,
                                    )))),
                        Padding(
                          padding:
                              const EdgeInsets.only(top: kDefaultPadding / 2),
                          child: Text(tvProvider.onTheAirLS[index].name,
                        ...
                        Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      tvProvider.onTheAirLS[index].voteAverage
                                          .toString(),
                                      style:
