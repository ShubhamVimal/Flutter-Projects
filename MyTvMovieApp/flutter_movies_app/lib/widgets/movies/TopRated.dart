...
class _TopRatedState extends State<TopRated> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<MoviesProvider>(context).topRatedMoviesData().then((_) {
        setState(() {
          _isLoading = false;
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    _pageController.addListener(() {
      if (_pageController.offset >= _pageController.position.maxScrollExtent &&
        ...
        // reached bottom
        if (newPage < 3) {
          temp.addMoreTopRated(nextPage: newPage);
          newPage += 1;
        } else {
          temp.setNoMore = true;
        }
        ...
        : Consumer<MoviesProvider>(
            builder: (ctx, mProvider, _) {
              return PageView.builder(
                  ...
                  itemCount: mProvider.getTopRatedMovies.length,
            ...
            child: InkWell(
              onTap: () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => MovieDetails(
                      movieId: mProvider.getTopRatedMovies[index].id))),
              child: Column(
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: BlurHash(
                          ...
                          image: 'https://image.tmdb.org/t/p/w500' +
                              mProvider.getTopRatedMovies[index].posterPath,
                        ),
                      ),
                    ),
                  ),
                  Padding(
                    ...
                    child: Text(mProvider.getTopRatedMovies[index].title,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                            mProvider.getTopRatedMovies[index].voteAverage
                                .toString(),
