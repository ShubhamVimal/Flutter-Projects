  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<MoviesProvider>(context)
          .getNowPlayingMovies(type: _type)
          .then((_) {
        setState(() {
          _isLoading = false;
        });
  ...
  Widget build(BuildContext context) {
    ...
    _pageController.addListener(() {
      if (_pageController.offset >= _pageController.position.maxScrollExtent &&
        ...
        // reached bottom
        if (newPage < 3) {
          temp.addMoreNowPlaying(nextPage: newPage, type: _type);
          newPage += 1;
        } else {
          temp.setNoMore = true;
        }
        ...
        : Container(
            ...
            builder: (ctx, mProvider, _) {
              return PageView.builder(
                  ...
                  itemCount: mProvider.getNowPlaying.length,
                  ...
                  child: InkWell(
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) => MovieDetails(
                              movieId: mProvider.getNowPlaying[index].id))),
                      child: Column(children: [
                            ...
                            child: ClipRRect(
                              ...
                              child: BlurHash(
                                ...
                                image: 'https://image.tmdb.org/t/p/w500' +
                                    mProvider.getNowPlaying[index].posterPath,
                              ),
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Text(mProvider.getNowPlaying[index].title,
                        ...
                        Padding(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      mProvider.getNowPlaying[index].voteAverage
                                          .toString(),
                                      style:
