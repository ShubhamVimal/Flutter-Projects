...
class _PopularState extends State<Popular> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<MoviesProvider>(context).popularMoviesData().then((_) {
        setState(() {
          _isLoading = false;
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    _pageController.addListener(() {
      if (_pageController.offset >= _pageController.position.maxScrollExtent &&
        ...
        // reached bottom
        if (newPage < 3) {
          temp.addMorePopular(nextPage: newPage);
          newPage += 1;
        } else {
          temp.setNoMore = true;
        }
        ...
        : Consumer<MoviesProvider>(
            builder: (ctx, mProvider, _) {
              return PageView.builder(
                  ...
                  itemCount: mProvider.getPopularMovies.length,
            ...
            child: InkWell(
              onTap: () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => MovieDetails(
                      movieId: mProvider.getPopularMovies[index].id))),
              child: Column(
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: BlurHash(
                          ...
                          image: 'https://image.tmdb.org/t/p/w500' +
                              mProvider.getPopularMovies[index].posterPath,
                        ),
                      ),
                    ),
                  ),
                  Padding(
                    ...
                    child: Text(mProvider.getPopularMovies[index].title,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                            mProvider.getPopularMovies[index].voteAverage
                                .toString(),
